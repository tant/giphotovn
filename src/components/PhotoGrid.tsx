    ...
    <>
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
        {photos.map((photo) => (
          <div
            key={photo.photo_id}
            className="group relative aspect-square cursor-pointer overflow-hidden rounded-xl bg-zinc-100 shadow-sm transition-shadow hover:shadow-md dark:bg-zinc-800"
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/0 transition-colors group-hover:bg-black/30">
              <div className="flex gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                <button
                  ...
                  className="rounded-xl bg-white/90 p-2.5 text-zinc-700 shadow-lg transition-all hover:bg-white hover:shadow-xl"
                  title="Download"
